...
import { Save, Loader2, ChevronDown, ChevronUp, Calculator, CheckCircle, AlertCircle, User, LogOut } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-blue-600 rounded-full flex items-center justify-center">
              <span className="font-bold text-white">IAB</span>
            </div>
            <div>
              <h1 className="text-xl font-bold text-slate-900">Portal do Professor</h1>
              <p className="text-sm text-slate-500">Lançamento de Notas</p>
            </div>
          </div>
